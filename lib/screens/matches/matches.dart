...
class _MatchesState extends State<Matches> {
  ...
  List<Match> allMatches = List.empty(growable: true);
          ...
          Row(
            children: [
              Container(
                  ...
                  child: Row(
                    children: [
                      SizedBox(height: 25, width: 25, child: Image.asset(cool)),
                      const Spacer(),
  ...
  Widget build(BuildContext context) {
    ...
    AppBar appBar =
        AppBar(centerTitle: false, title: Text(matches, style: size24bold));

    debugPrint(appBar.preferredSize.height.toString());
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: matchItem(allMatches[index]),
                    );
                  }),
            ),
          ],
